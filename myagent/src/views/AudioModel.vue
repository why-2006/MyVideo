...
.model-page-card.dark :deep(.ant-upload),
.inner-card.dark :deep(.ant-upload),
.model-page-card.dark :deep(.ant-upload-select),
.inner-card.dark :deep(.ant-upload-select) {
  background: #000000;
  border-color: #000000;
}

.model-page-card.dark :deep(audio),
.inner-card.dark :deep(audio) {
